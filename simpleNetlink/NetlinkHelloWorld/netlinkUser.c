...
int main() {
    ...
    nlh->nlmsg_flags = 0;                                     /* More about this Later*/

    /* Fill in the netlink message payload */
    strcpy(NLMSG_DATA(nlh), "Hello you!\n");                  /*Copy the application data to Netlink payload space. Use macro NLMSG_DATA to get ptr to netlink payload data space*/
