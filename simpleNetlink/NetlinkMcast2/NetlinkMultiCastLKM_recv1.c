...
static struct netlink_kernel_cfg cfg = {
    ...
    .groups = MCAST_GROUP_ID,       /*This Kernel Module has not joined any multicast group*/
};                   
                     
/*Init function of this kernel Module*/
static int __init NetlinkMultiCast_recv1_init(void) {
	...
	printk(KERN_INFO "Hello Kernel, I am kernel Module NetlinkMultiCast_recv1LKM.ko\n");
...
static void __exit NetlinkMultiCast_recv1_exit(void) {

	printk(KERN_INFO "Bye Bye. Exiting kernel Module NetlinkMultiCast_recv1LKM.ko \n");
...
module_init(NetlinkMultiCast_recv1_init); 
...
module_exit(NetlinkMultiCast_recv1_exit);
