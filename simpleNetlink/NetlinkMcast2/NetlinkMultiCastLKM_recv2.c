...
static int __init NetlinkMultiCast_recv2_init(void) {
	...
	printk(KERN_INFO "Hello Kernel, I am kernel Module NetlinkMultiCast_recv2LKM.ko\n");
...
static void __exit NetlinkMultiCast_recv2_exit(void) {

	printk(KERN_INFO "Bye Bye. Exiting kernel Module NetlinkMultiCast_recv2LKM.ko \n");
...
module_init(NetlinkMultiCast_recv2_init); 
...
module_exit(NetlinkMultiCast_recv2_exit);
